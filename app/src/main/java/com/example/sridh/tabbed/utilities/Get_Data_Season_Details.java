...
public class Get_Data_Season_Details extends AsyncTask<String,Integer,ShowDetails> {

    public AsyncResponse response;
    Context context;
    ShowDetails showDetails;
    String distance;
    public Get_Data_Season_Details(Context context,ShowDetails showDetails, AsyncResponse asyncResponse) {
    ...
    protected ShowDetails doInBackground(String... strings) {
        ...
        try {
            ...
            if(status == HttpURLConnection.HTTP_OK){
                ...
                return SeasonUtil.SeasonJSONParser.parseSeasonDetails(sb.toString(),showDetails);
            }
            else {
