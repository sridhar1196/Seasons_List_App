...
public class Get_Data_List extends AsyncTask<String,Integer,ShowDetails> {

    public AsyncResponse response;
    Context context;
    ShowDetails showDetails;
    public Get_Data_List(Context context,ShowDetails showDetails, AsyncResponse asyncResponse) {
    ...
    protected ShowDetails doInBackground(String... strings) {
        ...
        try {
            ...
            if(status == HttpURLConnection.HTTP_OK){
                ...
                return SeasonUtil.SeasonJSONParser.parseSeasonLists(sb.toString(),showDetails);
            }
            else {
